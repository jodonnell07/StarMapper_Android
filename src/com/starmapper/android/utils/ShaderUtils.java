...
public abstract class ShaderUtils {
	...
	public static int compileShader(final int shaderType, final String shaderSource) {
		...
		Log.d(TAG, "Printing ShaderInfoLog");
	 ...
	 */
	public static int createAndLinkShaderProgram(final int vertexShaderHandle, final int fragmentShaderHandle, final String[] attributes) {
		...
		if (programHandle != 0) {
			...
			// If link failed, delete shader program
			if (linkStatus[0] == 0) {
